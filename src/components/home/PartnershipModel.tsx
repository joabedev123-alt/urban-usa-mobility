    ...
    <section className="relative pt-28 pb-16 bg-midnight overflow-hidden border-t border-navy-border/50">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          ...
          className="p-8 sm:p-16 rounded-3xl glass-panel border border-urban-electric/40 shadow-2xl shadow-urban-blue/20 relative border-glow"
        >
          ...
          <h2 className="text-3xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-[1.05] tracking-tight">
